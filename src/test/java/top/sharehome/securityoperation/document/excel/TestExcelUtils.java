package top.sharehome.securityoperation.document.excel;
...
import top.sharehome.securityoperation.document.excel.entity.ExcelUser;
...
public class TestExcelUtils {
    ...
    private static final String EXCEL1_PATH_NAME = System.getProperty("user.dir") + "/src/test/java/top/sharehome/securityoperation/document/excel/file/test.xlsx";

    private static final String EXCEL2_PATH_NAME = System.getProperty("user.dir") + "/src/test/java/top/sharehome/securityoperation/document/excel/file/test_bak.xlsx";

    private static final String EXCEL_TEMPLATE_PATH_NAME = System.getProperty("user.dir") + "/src/test/java/top/sharehome/securityoperation/document/excel/file/template.xlsx";
