package top.sharehome.securityoperation.document.word;

import top.sharehome.securityoperation.utils.document.word.WordUtils;
...
public class TestWordReadAndWrite {
    ...
    private static final String READABLE_WORD_PATH_NAME = System.getProperty("user.dir") + "/src/test/java/top/sharehome/securityoperation/document/word/file/readable.docx";

    private static final String WRITABLE_WORD_FILE_PATH_NAME = System.getProperty("user.dir") + "/src/test/java/top/sharehome/securityoperation/document/word/file/temp.docx";
