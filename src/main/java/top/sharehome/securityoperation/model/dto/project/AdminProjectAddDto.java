...
public class AdminProjectAddDto implements Serializable {

    /**
     * 项目名称
     */
    @Size(min = 1, max = 20, message = "项目名称长度介于1-20位之间", groups = {PostGroup.class})
    @NotBlank(message = "项目名称不能为空", groups = {PostGroup.class})
    private String name;

    /**
     * 项目描述
     */
    @Size(min = 1, max = 500, message = "项目描述长度介于1-500位之间", groups = {PostGroup.class})
    @NotBlank(message = "项目描述不能为空", groups = {PostGroup.class})
