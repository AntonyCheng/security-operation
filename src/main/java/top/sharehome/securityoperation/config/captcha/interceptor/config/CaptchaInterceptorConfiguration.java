package top.sharehome.securityoperation.config.captcha.interceptor.config;
...
import top.sharehome.securityoperation.config.captcha.interceptor.CaptchaInterceptor;
