package top.sharehome.securityoperation.config.log.aop;
...
import top.sharehome.securityoperation.exception.CustomizeException;
...
public class ControllerLogAop {
     ...
     * 定义切入点方法
     */
    @Pointcut("@annotation(top.sharehome.securityoperation.config.log.annotation.ControllerLog)")
