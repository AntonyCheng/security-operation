package top.sharehome.securityoperation.aop.studyDemo.annotation.atWithinAop;
...
public class AtWithinAspect {
     ...
     * 定义切入点方法
     */
    @Pointcut("execution(* *..aop..atWithinAop..* (..)) && @within(top.sharehome.securityoperation.aop.studyDemo.annotation.atWithinAop.annotation.AtWithinAop)")
