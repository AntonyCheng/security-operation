package top.sharehome.securityoperation.aop.studyDemo.annotation.atArgsAop;
...
public class AtArgsAspect {
     ...
     * 定义切入点方法
     */
    @Pointcut("execution(* *..aop..atArgsAop..* (..)) && @args(top.sharehome.securityoperation.aop.studyDemo.annotation.atArgsAop.annotation.AtArgsAop)")
